package com.example.fortuneapp.B;
...
import com.example.fortuneapp.CustomView.MyNumberPicker;
import com.example.fortuneapp.R;
import com.example.fortuneapp.Utilize.Util;

public class AppB02Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    /** 定数の定義 */
    private final int YEAR_FIRST = 1970;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_b02);
    ...
    private void transitionScreen(int year, int month, int day){
        Util.otherBirthYear = year;
        Util.otherBirthMonth = month;
        Util.otherBirthDay = day;
        Intent intent = new Intent(getApplication(), AppB03Activity.class);
