...
public class MyRouletteView extends View {
    ...
    //選ばれた場所の色
    private final int selectedRoulette = getResources().getColor(R.color.subColor);
    //選ばれてない場所の色
    private final int nonSelectedRoulette = getResources().getColor(R.color.baseColor);
    //ルーレット上の文字の色
    private final int rouletteText = getResources().getColor(R.color.black);
    //ルーレットの線の色
    private final int rouletteStroke = getResources().getColor(R.color.black);
    //ルーレット上の文字のサイズ
